...
from ascii_tables import ASCIITable
...
def get_sudoku_results(sudoku_to_solve):
    ...
    print("Originally:")
    table = ASCIITable.from_2d_list(sudoku_to_solve,3,3)
    print(table.get_ascii_table())
    print()
    print("Solved:")
    table = ASCIITable.from_2d_list(solver.solve_sudoku(),3,3)
    print(table.get_ascii_table())
